...
path_model = './visual/SME_train/20240410/0402_1137_model_750_DVSGesture_SME_nda30_11c_24ms_20240403_0.9826'
...
evaluation_utils.get_evaluation_results(path_model, path_weights)
...
flops, activated_patches, macs = get_complexity_stats(model, all_params)
...
print(f' - Model FLOPs: {flops*1e-6:.2f} M')
print(f' - Model MACS: {macs*1e-6:.2f} M')
