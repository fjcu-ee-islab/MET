...
class EventSlicer:
    ...
    def get_events(self, t_start_us: int, t_end_us: int) -> Dict[str, np.ndarray]:
        ...
        print("self.t_offset = ", self.t_offset)
        t_start_us -= self.t_offset
        t_end_us -= self.t_offset
        print("offseted_t_start_us = ", t_start_us)
        print("offseted_t_end_us = ", t_end_us)
...
class Sequence(Dataset):
    def __init__(self, seq_path: Path, representation_type: RepresentationType, mode: str='test', delta_t_ms: int=100,
        ...
        print("test_timestamp_file = ", test_timestamp_file)
        ...
        for i in range(len(names)):
            ...
            if self.voxel_grid is None:
                ...
                if t.shape[0] == 0: 
                    ...
                    print('ts_start[i] = ', ts_start[i])
                    print('ts_end[i] = ', ts_end[i])
                    breakpoint()
