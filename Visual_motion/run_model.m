...
addpath(genpath('functions'))
    ...
    labdata = load(['Data/test data/', filesep, filename]);
    ...
    %%% Save the results:
    pname = './Results';
    savefolder = fullfile(pname,filename);

    save([savefolder, filesep, filename, '_layer1'], 'layer1_output')
    ...
    layer2_output = spike_layer_2(layer1_output, filters, spike_threshold, decay_rate, reset_potential, filename);
    ...
    save([savefolder, filesep, filename, '_layer2'], 'layer2_output');
