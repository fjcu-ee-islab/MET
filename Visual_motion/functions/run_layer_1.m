...
if ~isempty(pos_events)
    ...
    pos_layer1_output = spike_layer_1(pos_events_refracted, filters, spike_threshold, decay_rate, reset_potential, filename);
...
if ~isempty(neg_events)
    ...
    neg_layer1_output = spike_layer_1(neg_events_refracted, filters, spike_threshold, decay_rate, reset_potential, filename);
...
layer1_output.filename = filename;
layer1_output.layer = "layer1";
toc
