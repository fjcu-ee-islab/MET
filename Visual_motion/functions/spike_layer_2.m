function output_spikes = spike_layer_2(input_spikes, filters, spike_threshold, decay_rate, reset_potential, filename)
...
output_spikes.filename = filename;
output_spikes.layer = "layer2";