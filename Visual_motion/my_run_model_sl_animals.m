function my_run_model_sl_animals(InputFileDir, ResultDir)
% function my_run_model_sl_animals()

addpath(genpath('functions'))

MainDir = pwd
% InputFileDir = './Data/SL_Animals_DVS_dataset/work01/';
% ResultDir = './Results/SL_Animals_DVS_dataset/';
